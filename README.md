...
- Open the .dxt file in Claude Desktop (double click, don't drag into the chat input box)
- Click the "Install" button
- Enter your Clay API key from [clay.earth](https://web.clay.earth/settings/api-keys)
- Make sure the extension is enabled and you're good!

*All of the below is from the [clay-mcp](https://github.com/clay-inc/clay-mcp) README.md*
